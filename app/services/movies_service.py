...
def get_films(film) -> list:
    ...
    try:
        ...
        logger.error(f"Get Films error - film: {film} | error: {e}")
        raise
...
def get_movie_sentiment(list_review: list) -> dict:
    ...
    try:
        ...
        logger.error(f"Get Movie Sentiment error - films: {list_review} | error: {e}")
        raise
